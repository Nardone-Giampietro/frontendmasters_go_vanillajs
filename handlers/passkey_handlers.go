...
// This is the registration of the passkey, not of the user. When I create a passkey, I need to know the
// user it belongs to. So, we need authentication of the user.
...
// For the authentication I don't need to use the authentication middleware. We are authenticate the user
// with the passkey.
